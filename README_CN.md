...
- **10 套视觉主题** — 简约亮色（高级感）、杂志衬线（人文感）、极光暗夜（科技感）、新粗暴主义（Gen Z 潮流）、禅意花园（自然舒适）、复古日落（怀旧风）、深炭金紫（商业高端）、浅彩磨砂玻璃（现代 SaaS）、黑白报刊（严肃深度）、柔粉淡紫（治愈美学）
...
| **Mono Press** | 亮色 | 纯黑白高对比纸质 | 严肃新闻、深度报道 |

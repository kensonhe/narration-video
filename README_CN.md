...
- **7 套视觉主题** — 简约亮色（高级感）、杂志衬线（人文感）、极光暗夜（科技感）、复古日落（怀旧风）、深炭金紫（商业高端）、浅彩磨砂玻璃（现代 SaaS）、柔粉淡紫（治愈美学）
...
- **平台安全内容** — 自动过滤旁白、字幕和画面文字中的 URL、GitHub/npm 等外部平台引导，防止视频被平台限流
...
| **Midnight Gold** | 深色 | 深炭金紫、玻璃卡片 | 商业、财经深度、高端 |
| **Prism Glass** | 鲜艳 | 浅彩渐变、磨砂玻璃 | SaaS、创业、现代 |
| **Blossom** | 亮色 | 柔粉淡紫、玻璃卡片 | 治愈、情感、生活美学 |
...
视频平台（抖音、B站、小红书、视频号）会主动限流或封禁引导用户跳转外部网站的视频内容。此技能在撰写解说文案（Phase 2）时强制执行严格的内容规则：

**自动过滤以下内容（旁白、字幕、画面文字、发布文案）：**
